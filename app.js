...
app.message("", async ({ message, say }) => {
  if (
    ...
    if (messagesWithPrompt.length > 10) {
      messagesWithPrompt.splice(1, 2);
    }
    try {
      await say({
